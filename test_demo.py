...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default="/root/autodl-tmp/NTIRE2025_ESR-main/valid", type=str)
    parser.add_argument("--save_dir", default="../results_valid", type=str)
    parser.add_argument("--model_id", default=13, type=int)
